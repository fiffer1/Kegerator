...
pint = pygame.image.load('/home/pi/Projects/Kegerator/images/pint.jpg')
#pint = pygame.transform.scale(pint,(150,150)) # update to correct size
	
mug = pygame.image.load('/home/pi/Projects/Kegerator/images/mug.jpg')
#mug = pygame.transform.scale(mug,(100,100)) # update to correct size
	
pilsner = pygame.image.load('/home/pi/Projects/Kegerator/images/pilsner.jpg')
#pilsner = pygame.transform.scale(pilsner,(100,100)) # update to correct size
	
weizen = pygame.image.load('/home/pi/Projects/Kegerator/images/weizen.jpg')
#weizen = pygame.transform.scale(weizen,(100,100)) # update to correct size
	
tulip = pygame.image.load('/home/pi/Projects/Kegerator/images/tulip.jpg')
#tulip = pygame.transform.scale(tulip,(100,100)) # update to correct size
	
snifter = pygame.image.load('/home/pi/Projects/Kegerator/images/snifter.jpg')
#snifter = pygame.transform.scale(snifter,(100,100)) # update to correct size
	
goblet = pygame.image.load('/home/pi/Projects/Kegerator/images/goblet.jpg')
...
SRM41 = (192,192,192) #C0C0C0
SRM42 = (128,128,128) #808080
SRM43 = (255,255,255) #FFFFFF

	
# Beer 1 (Left Tap ) Variables =========================================================================================================
beer1name = "Stone Pataskala" # notes about length here
beer1style = "Red IPA" # notes about length here
beer1OG = "OG: N/A" # notes about layout here
beer1ibu = "IBU: 70" # notes about layout here
beer1abv = "ABV: 7.8%" # notes about layout here
beer1glasspic = tap # select from Beer Glass Variables
...
beer3glasspic = tap # select from Beer Glass Variables
